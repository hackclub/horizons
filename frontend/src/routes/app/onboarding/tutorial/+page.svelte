		...
		<div class="absolute inset-0 flex items-center justify-center">
			...
			<div class="relative z-1 w-181.75 min-h-165.5 bg-[#f3e8d8] border-4 border-black rounded-[20px] p-7.5 shadow-[4px_4px_0px_0px_black] flex flex-col justify-between items-center overflow-hidden">
				{#if isStep1}
					...
					<button class="card-btn w-103.75 py-2 px-4 border-2 border-black rounded-lg bg-transparent font-bricolage text-base font-semibold text-black cursor-pointer transition-[transform,background-color] duration-(--juice-duration) ease-(--juice-easing) hover:scale-(--juice-scale) hover:bg-[#ffa936]" onclick={() => step++}>
						Continue
					</button>
				{/if}
					...
					<div class="w-full flex-1">
						<div class="flex flex-col gap-6 w-full">
							<div class="flex flex-col gap-2">
								...
								<p class="font-bricolage text-2xl font-medium text-black leading-normal">Set up Hackatime to track your coding time!</p>
							</div>
							...
							<!-- Hackatime Setup (shown after linking) -->
							{#if hackatimeLinked}
								<div class="flex flex-col gap-2 w-full">
									<p class="font-bricolage text-2xl font-bold text-black leading-normal">
				...
				{#if isStep4}
					<div class="w-full flex-1">
						<div class="flex flex-col gap-6 w-full">
							<div class="flex flex-col gap-2">
								<h1 class="font-cook text-2xl text-black leading-normal">STEP 4</h1>
