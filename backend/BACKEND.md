...
| GET | `/submissions/:id` | Reviewer | Full submission detail with timeline. Includes `userBalance`, the submitter's live shop balance (approved hours minus non-refunded purchases) |
